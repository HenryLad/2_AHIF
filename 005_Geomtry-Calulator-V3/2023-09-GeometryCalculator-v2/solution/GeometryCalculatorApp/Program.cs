...
Console.WriteLine($"The original area of the {myShape} and the Area is :  {myShape.Area}.");
myShape.Scale(factor);
Console.WriteLine($"The new area of {myShape} is {Math.Round(myShape.Area, 3)}.");


/*
Shape myShape = new Rectangle(10d, 10d);
System.Console.WriteLine(" Area :" + myShape.Area);
myShape.Scale(2);
//Object myObject = new Circle(10d); // Object myObject = 10; Object myObject = myShape;*/
